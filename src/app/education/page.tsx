      ...
      <div className="relative border-l-2 border-green-500">
        {education.map((edu, index) => (
          <div key={index} className="mb-10 ml-6">
            <span className="absolute -left-3 flex items-center justify-center w-3 h-3 bg-green-500 rounded-full ring-8 ring-white"></span>
            <h3 className="text-md font-semibold text-gray-900">{edu.course}</h3>
